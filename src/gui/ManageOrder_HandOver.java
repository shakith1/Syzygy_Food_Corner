 ...
 * @author nimsa
 */
public class ManageOrder_HandOver extends ManageOrders {
     ...
     */
    public ManageOrder_HandOver(Orders orders, OrderManagementGroup managementGroup, ManageOrder manageOrder) {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Hand Over To Driver");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        orders.setIsHandedOver(true);
        this.managementGroup.sendMessage(Messages.ORDER_COMPLETED);
